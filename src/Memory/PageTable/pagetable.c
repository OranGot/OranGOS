...
#define KERNEL_OFFSET_IN_PAGE_TABLES KERNEL_OFFSET_IN_PAGES / 1024
...
void paging_setup(void) {
  ...
  for (uint32_t i = 0; i < PAGE_TABLE_SIZE; i++) {
    ...
    kernel_page_table6[i] |= DEFAULT_KERNEL_FLAGS;
    kernel_page_table7[i] |= DEFAULT_KERNEL_FLAGS;
    kernel_page_table8[i] |= DEFAULT_KERNEL_FLAGS;
    kernel_page_table9[i] |= DEFAULT_KERNEL_FLAGS;
  ...
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+1] = ((uint32_t)kernel_page_table2) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+2] = ((uint32_t)kernel_page_table3) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+3] = ((uint32_t)kernel_page_table4) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+4] = ((uint32_t)kernel_page_table5) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+5] = ((uint32_t)kernel_page_table6) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+6] = ((uint32_t)kernel_page_table7) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+7] = ((uint32_t)kernel_page_table8) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+8] = ((uint32_t)kernel_page_table9) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+9] = ((uint32_t)kernel_page_table10) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+10] = ((uint32_t)kernel_page_table11) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+11] = ((uint32_t)kernel_page_table12) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+12] = ((uint32_t)kernel_page_table13) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+13] = ((uint32_t)kernel_page_table14) | 3;
  kernel_page_directory[KERNEL_OFFSET_IN_PAGE_TABLES+14] = ((uint32_t)kernel_page_table15) | 3;
